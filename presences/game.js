...
client.on("ready", async () => {
  ...
  largeImage = config.game.largeImageKey
    ? await discord.getImage(
        config.game.applicationID,
        config.game.largeImageKey
      )
    : null;
  smallImage = config.game.smallImageKey
    ? await discord.getImage(
        config.game.applicationID,
        config.game.smallImageKey
      )
    : null;
