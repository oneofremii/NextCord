...
client.on("ready", async () => {
  ...
  largeImage = config.twitch.largeImageKey
    ? await discord.getImage(
        config.twitch.applicationID,
        config.twitch.largeImageKey
      )
    : null;
  smallImage = config.twitch.smallImageKey
    ? await discord.getImage(
        config.twitch.applicationID,
        config.twitch.smallImageKey
      )
    : null;
