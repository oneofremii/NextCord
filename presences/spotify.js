...
client.on("ready", async () => {
  ...
  let presence = rpc.createSpotifyRpc(client).setType("LISTENING");
  ...
  if (config.spotify.largeImageKey.startsWith("spotify:"))
    presence.setAssetsLargeImage(config.spotify.largeImageKey);
  if (config.spotify.smallImageKey.startsWith("spotify:"))
